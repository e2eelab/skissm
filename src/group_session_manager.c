...
static void handle_get_group_response(
    ...
    copy_member_addresses_from_member_addresses(&(this_handler->member_addresses), (const Org__E2eelab__Lib__Protobuf__E2eeAddress **)member_addresses, member_num);
...
static void handle_add_group_members_response(
    ...
    Org__E2eelab__Lib__Protobuf__E2eeAddress *sender_address = this_handler->outbound_group_session->session_owner;
    Org__E2eelab__Lib__Protobuf__E2eeAddress *group_address = this_handler->outbound_group_session->group_address;
    ...
    Org__E2eelab__Lib__Protobuf__E2eeAddress **member_addresses = (Org__E2eelab__Lib__Protobuf__E2eeAddress **) malloc(sizeof(Org__E2eelab__Lib__Protobuf__E2eeAddress *) * member_num);
    size_t i;
    ...
    for (j = 0; j < this_handler->removing_member_num; j++){
        for (i = 0; i < original_member_num; i++){
            if (compare_address((this_handler->outbound_group_session->member_addresses)[i], (this_handler->removing_member_addresses)[j])){
                org__e2eelab__lib__protobuf__e2ee_address__free_unpacked((this_handler->outbound_group_session->member_addresses)[i], NULL);
...
get_group_response_handler *get_group_members(Org__E2eelab__Lib__Protobuf__E2eeAddress *group_address){
