...
void update_identity_key(ProtobufCBinaryData *account_id, Skissm__KeyPair *identity_key_pair);
void update_signed_pre_key(ProtobufCBinaryData *account_id, Skissm__SignedPreKeyPair *signed_pre_key);
...
void add_one_time_pre_key(ProtobufCBinaryData *account_id, Skissm__OneTimePreKeyPair *one_time_pre_key);
