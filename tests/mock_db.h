...
void update_identity_key(uint64_t address_id, Skissm__IdentityKey *identity_key_pair);
void update_signed_pre_key(uint64_t address_id, Skissm__SignedPreKey *signed_pre_key);
void load_signed_pre_key(uint64_t address_id, uint32_t spk_id, Skissm__SignedPreKey **signed_pre_key_pair);
...
void load_auth(uint64_t address_id, char *auth); // new added
