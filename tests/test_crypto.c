...
static unsigned digital_signature_data_selected[] = {
    E2EE_PACK_ID_DIGITAL_SIGNATURE_DILITHIUM5,
    E2EE_PACK_ID_DIGITAL_SIGNATURE_FALCON1024,
    E2EE_PACK_ID_DIGITAL_SIGNATURE_SPHINCS_SHA2_256S,
    E2EE_PACK_ID_DIGITAL_SIGNATURE_SPHINCS_SHAKE_256F
};

static unsigned kem_data_selected[] = {
    E2EE_PACK_ID_KEM_HQC256,
    E2EE_PACK_ID_KEM_KYBER1024
};

static unsigned digital_signature_data_all[] = {
    E2EE_PACK_ID_DIGITAL_SIGNATURE_DILITHIUM2,
    E2EE_PACK_ID_DIGITAL_SIGNATURE_DILITHIUM3,
    E2EE_PACK_ID_DIGITAL_SIGNATURE_DILITHIUM5,
    E2EE_PACK_ID_DIGITAL_SIGNATURE_FALCON512,
    E2EE_PACK_ID_DIGITAL_SIGNATURE_FALCON1024,
    E2EE_PACK_ID_DIGITAL_SIGNATURE_SPHINCS_SHA2_128F,
    E2EE_PACK_ID_DIGITAL_SIGNATURE_SPHINCS_SHA2_128S,
    E2EE_PACK_ID_DIGITAL_SIGNATURE_SPHINCS_SHA2_192F,
    E2EE_PACK_ID_DIGITAL_SIGNATURE_SPHINCS_SHA2_192S,
    E2EE_PACK_ID_DIGITAL_SIGNATURE_SPHINCS_SHA2_256F,
    E2EE_PACK_ID_DIGITAL_SIGNATURE_SPHINCS_SHA2_256S,
    E2EE_PACK_ID_DIGITAL_SIGNATURE_SPHINCS_SHAKE_128F,
    E2EE_PACK_ID_DIGITAL_SIGNATURE_SPHINCS_SHAKE_128S,
    E2EE_PACK_ID_DIGITAL_SIGNATURE_SPHINCS_SHAKE_192F,
    E2EE_PACK_ID_DIGITAL_SIGNATURE_SPHINCS_SHAKE_192S,
    E2EE_PACK_ID_DIGITAL_SIGNATURE_SPHINCS_SHAKE_256F,
    E2EE_PACK_ID_DIGITAL_SIGNATURE_SPHINCS_SHAKE_256S
};

static unsigned kem_data_all[] = {
    E2EE_PACK_ID_KEM_HQC128,
    E2EE_PACK_ID_KEM_HQC192,
    E2EE_PACK_ID_KEM_HQC256,
    E2EE_PACK_ID_KEM_KYBER512,
    E2EE_PACK_ID_KEM_KYBER768,
    E2EE_PACK_ID_KEM_KYBER1024,
    // E2EE_PACK_ID_KEM_MCELIECE348864,
    // E2EE_PACK_ID_KEM_MCELIECE348864F,
    // E2EE_PACK_ID_KEM_MCELIECE460896,
    // E2EE_PACK_ID_KEM_MCELIECE460896F,
    // E2EE_PACK_ID_KEM_MCELIECE6688128,
    // E2EE_PACK_ID_KEM_MCELIECE6688128F,
    // E2EE_PACK_ID_KEM_MCELIECE6960119,
    // E2EE_PACK_ID_KEM_MCELIECE6960119F,
    // E2EE_PACK_ID_KEM_MCELIECE8192128,
    // E2EE_PACK_ID_KEM_MCELIECE8192128F
};
