...
static void test_verify_pre_key_bundle() {
    ...
    Skissm__GetPreKeyBundleResponse *get_pre_key_bundle_response = get_skissm_plugin()->proto_handler.get_pre_key_bundle(account->address, account->auth, get_pre_key_bundle_request);
