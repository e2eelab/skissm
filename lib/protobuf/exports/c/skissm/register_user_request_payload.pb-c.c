...
static const ProtobufCFieldDescriptor org__e2eelab__skissm__proto__register_user_request_payload__field_descriptors[5] =
{
  {
    "user_name",
    1,
  ...
  },
  {
    ...
    PROTOBUF_C_TYPE_STRING,
    0,   /* quantifier_offset */
    offsetof(Org__E2eelab__Skissm__Proto__RegisterUserRequestPayload, device_id),
    NULL,
    &protobuf_c_empty_string,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
